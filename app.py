...
INTENT_TO_MONGODB_COLUMN = {
    ...
    "AnnualReport - Standalone - DividentIncome": ("AFS_Dividend_income", "standalone divident income", "Crores"),
    "AnnualReport - Standalone - TotalExpenses": ("AFS_Total_expenses", "standalone total expenses", "Crores"),
    "AnnualReport - Standalone - BankBalance": ("AFS_Bank_balance_short_term", "standalone bank balance(short term)", "Crores"),
    "AnnualReport - Standalone - NetfixedAssets": ("AFS_Net_fixed_assets", "standalone net fixed assets", "Crores"),
    "AnnualReport - Standalone - TotalLiabilities": ("AFS_Total_liabilities", "standalone total liabilities", "Crores"),
    "AnnualReport - Standalone - Sales": ("AFS_Sales", "standalone sales data", "Crores"),
    "AnnualReport - Standalone - TotalCapital": ("AFS_Total_capital", "standalone total capital", "Crores"),
    "AnnualReport - Standalone - ProfitAfterTax": ("AFS_Profit_after_tax", "standalone profit after tax", "Crores"),
